...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/SZUU07va5C)
...
```sh
npx nx serve deployment-team
```

To create a production bundle:

```sh
npx nx build deployment-team
```

To see all available targets to run for a project, run:

```sh
npx nx show project deployment-team
```
